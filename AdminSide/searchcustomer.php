...
<div class="container">
    ...
    <form action="" method="GET">
        <div class="row">
            <div class="col-md-2"><input type="text" name="search" required value="<?php if (isset($_GET['search'])){echo $_GET['search'];} ?>" placeholder="Order #"><br>
            </div>
        ...
        <tbody>
            <?php 
                if (isset($_GET['search'])){
                    ...
                    $query = "SELECT * FROM purchase WHERE purchaseid LIKE '$filtervalues' ";
