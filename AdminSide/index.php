...
<body>
 <style>
      body {
        background: linear-gradient(to bottom, green 40%,white);
      }
    </style>
<?php include('navbar.php'); ?>
<div class="container">
	<h1 style="color: white;" class="page-header text-center"><strong>MENU</strong></h1>
	<ul class="nav nav-tabs">
		<?php
			...
			?>
				<li style="font-weight: bolder; font-size: 20px;" class="active"><a style="color: black ;"data-toggle="tab" href="#<?php echo  $frow ['catname'] ?>"><?php echo $frow['catname'] ?></a></li>
			<?php
			...
			while($row=$query->fetch_array()){
				?>
				<li style="font-weight:bolder; font-size: 20px; "><a style="color: black ;" data-toggle="tab" href="#<?php echo $row['catname'] ?>"><?php echo $row['catname'] ?></a></li>
				<?php
			}
		?>
	</ul>
